...
public class IhubDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE =
            "create table if not exists members  (id integer primary key autoincrement, " + "firstName text not null, lastName text not null, qrCode text not null, occupation text not null, profilePic text not null, userID text not null, " + "country text not null);";
    ...
    public void createDatabase() {
        myDataBase = myContext.openOrCreateDatabase(DATABASE_NAME, SQLiteDatabase.CREATE_IF_NECESSARY, null);
    }

    public long addMember(String firstName, String lastName, String country, String qrCode, String profilePic, String occupation, String userID) {
  ...
  //---retrieves a particular record---
    ...
    public boolean updateMemberDetails(long rowId, String firstName,
            String lastName, String country, String qrCode, String profilePic, String occupation) {
